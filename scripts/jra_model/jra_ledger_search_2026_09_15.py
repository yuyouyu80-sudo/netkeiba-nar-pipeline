...
data/jra_pipeline/factor_database.json(2026-09-14時点、レーダー細分化9本を含む
81グループ・236atom)を候補プールにビームサーチで(再)構築する。
...
候補プール: jra_factor_registry.FACTOR_GROUPS 全81グループ・236atom(2026-09-14の
レーダー細分化9グループ・27atomを含む)。1パターン=最大6グループから1atomずつ選んだ
組み合わせ(グループ間AND、グループ内は元々1値のみなのでOR相当の意味は無い)。
