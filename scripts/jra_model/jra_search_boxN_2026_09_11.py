...
ほしい」に対応する、box_n={5,4}用の重み再探索(box3専用スクリプトの汎用化版)。jra_search_2026_08_12.pyと同じ方法論
...
出力: data/jra_pipeline/jra_search_box{BOX_N}_2026_09_11_result.json / _report.txt
"""
import json
import sys
...
SEED = 2911
BOX_N = int(sys.argv[1]) if len(sys.argv) > 1 else 3
WINNER_FILE = {5: "winner_v3.json", 4: "winner_box4.json", 3: "winner_box3.json"}[BOX_N]

OUT_JSON = DATA_DIR / f"jra_search_box{BOX_N}_2026_09_11_result.json"
OUT_TXT = DATA_DIR / f"jra_search_box{BOX_N}_2026_09_11_report.txt"
